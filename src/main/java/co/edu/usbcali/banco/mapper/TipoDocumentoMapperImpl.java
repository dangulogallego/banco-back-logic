...
public class TipoDocumentoMapperImpl implements TipoDocumentoMapper {
	...
	public TipoDocumentoDTO tipoDocumentoToTipoDocumentoDTO(TipoDocumento tipoDocumento) throws Exception {
		try {
			...
			tipoDocumentoDTO.setActivo((tipoDocumento.getActivo() != null) ? tipoDocumento.getActivo() : null);
			tipoDocumentoDTO.setNombre((tipoDocumento.getNombre() != null) ? tipoDocumento.getNombre() : null);
	...
	public TipoDocumento tipoDocumentoDTOToTipoDocumento(TipoDocumentoDTO tipoDocumentoDTO) throws Exception {
		try {
			...
			tipoDocumento.setActivo((tipoDocumentoDTO.getActivo() != null) ? tipoDocumentoDTO.getActivo() : null);
			tipoDocumento.setNombre((tipoDocumentoDTO.getNombre() != null) ? tipoDocumentoDTO.getNombre() : null);
	...
	@Transactional(readOnly = true)
	public List<TipoDocumentoDTO> listTipoDocumentoToListTipoDocumentoDTO(List<TipoDocumento> listTipoDocumento)
			throws Exception {
		try {
	...
	@Transactional(readOnly = true)
	public List<TipoDocumento> listTipoDocumentoDTOToListTipoDocumento(List<TipoDocumentoDTO> listTipoDocumentoDTO)
			throws Exception {
		try {
