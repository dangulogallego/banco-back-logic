...
public class TipoUsuarioMapperImpl implements TipoUsuarioMapper {
	...
	public TipoUsuarioDTO tipoUsuarioToTipoUsuarioDTO(TipoUsuario tipoUsuario) throws Exception {
		try {
			...
			tipoUsuarioDTO.setActivo((tipoUsuario.getActivo() != null) ? tipoUsuario.getActivo() : null);
			tipoUsuarioDTO.setNombre((tipoUsuario.getNombre() != null) ? tipoUsuario.getNombre() : null);
