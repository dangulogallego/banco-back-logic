...
public class UsuarioMapperImpl implements UsuarioMapper {
	...
	public UsuarioDTO usuarioToUsuarioDTO(Usuario usuario) throws Exception {
		try {
			...
			usuarioDTO.setActivo((usuario.getActivo() != null) ? usuario.getActivo() : null);
			usuarioDTO.setClave((usuario.getClave() != null) ? usuario.getClave() : null);
			usuarioDTO.setIdentificacion((usuario.getIdentificacion() != null) ? usuario.getIdentificacion() : null);
			usuarioDTO.setNombre((usuario.getNombre() != null) ? usuario.getNombre() : null);
			usuarioDTO.setTiusId(
					(usuario.getTipoUsuario().getTiusId() != null) ? usuario.getTipoUsuario().getTiusId() : null);
